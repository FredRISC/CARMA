...
void imatmul(int8_t *c, const int8_t *a, const int8_t *b,
...
void imatmul_4x4(int8_t *c, const int8_t *a, const int8_t *b,
 ...
 // asm volatile("vsetvli %0, %1, e64, m4, ta, ma" : "=r"(block_size_p) : "r"(P)); //SEW=64, LMUL=4
  asm volatile("vsetvli %0, %1, e8, m4, ta, ma" : "=r"(block_size_p) : "r"(P)); //SEW=8, LMUL=4
...
void imatmul_vec_4x4_slice_init() {
  asm volatile("vmv.v.i v0,  0"); //initialize acc = 0
  asm volatile("vmv.v.i v4,  0");
  asm volatile("vmv.v.i v8,  0");
  asm volatile("vmv.v.i v12, 0");
}

void imatmul_vec_4x4(int8_t *c, const int8_t *a, const int8_t *b,
  ...
  asm volatile("vle8.v v16, (%0);" ::"r"(b)); //64-bit unit-stride load with b being the base address
  b += P;
  ...
  while (n < N) {
    ...
    asm volatile("vmacc.vx v0, %0, v16" ::"r"(t0)); //vmacc.vx vd, rs1, vs2, vm // v0[i] = (t0 * v16[i]) + v0[i]
    t0 = *a, a += N;
  ...
  c += P;
  asm volatile("vmacc.vx v4, %0, v20" ::"r"(t1));
  asm volatile("vse8.v v4, (%0);" ::"r"(c));
  c += P;
  asm volatile("vmacc.vx v8, %0, v20" ::"r"(t2));
  asm volatile("vse8.v v8, (%0);" ::"r"(c));
  c += P;
  asm volatile("vmacc.vx v12, %0, v20" ::"r"(t3));
  asm volatile("vse8.v v12, (%0);" ::"r"(c));
}
...
void imatmul_vec_8x8(int8_t *c, const int8_t *a, const int8_t *b,
                     const unsigned long int N, const unsigned long int P) {
  // Temporary variables
  ...
  c += P;
  asm volatile("vmacc.vx v2, %0, v20" ::"r"(t1));
  asm volatile("vse8.v v2, (%0);" ::"r"(c));
  c += P;
  asm volatile("vmacc.vx v4, %0, v20" ::"r"(t2));
  asm volatile("vse8.v v4, (%0);" ::"r"(c));
  c += P;
  asm volatile("vmacc.vx v6, %0, v20" ::"r"(t3));
  asm volatile("vse8.v v6, (%0);" ::"r"(c));
  c += P;
  asm volatile("vmacc.vx v8, %0, v20" ::"r"(t4));
  asm volatile("vse8.v v8, (%0);" ::"r"(c));
  c += P;
  asm volatile("vmacc.vx v10, %0, v20" ::"r"(t5));
  asm volatile("vse8.v v10, (%0);" ::"r"(c));
  c += P;
  asm volatile("vmacc.vx v12, %0, v20" ::"r"(t6));
  asm volatile("vse8.v v12, (%0);" ::"r"(c));
  c += P;
  asm volatile("vmacc.vx v14, %0, v20" ::"r"(t7));
  asm volatile("vse8.v v14, (%0);" ::"r"(c));
}
